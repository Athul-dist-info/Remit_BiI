...
class NewRetainedCustomersAnalysis extends StatefulWidget {
  const NewRetainedCustomersAnalysis({
    super.key,
    required this.title,
  ...
  @override
  State<NewRetainedCustomersAnalysis> createState() =>
      _NewRetainedCustomersAnalysisState();
}

class _NewRetainedCustomersAnalysisState
    extends State<NewRetainedCustomersAnalysis> {
  ...
  Future<void> loadRemittanceData() async {
    ...
    try {
      final responseData = await remittanceController
          .getNewRetainedCustomersAnalysis(
            fromDate:
                            ...
                            children: [
                              ...
                              graphValue == 1
                                  ? VerticalBarGraph(
                                    ...
                                    valueFormatter:
                                        ChartFormatters.formatToMillion,
                                    xAxisLabel: 'Branch',
