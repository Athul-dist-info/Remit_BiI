...
class CorpIndividualBranchWiseAnalysis extends StatefulWidget {
  const CorpIndividualBranchWiseAnalysis({
    super.key,
    required this.title,
  ...
  @override
  State<CorpIndividualBranchWiseAnalysis> createState() =>
      _CorpIndividualBranchWiseAnalysisState();
}

class _CorpIndividualBranchWiseAnalysisState
    extends State<CorpIndividualBranchWiseAnalysis> {
  ...
  Future<void> loadRemittanceData() async {
    ...
    try {
      final responseData = await remittanceController
          .getCorpIndividualBranchAnalysis(
            fromDate:
      ...
      legendItems =
          responseData.map((e) => e.branchDescription).toSet().toList();
      legendItemsForPie = responseData.map((e) => e.custType).toSet().toList();
